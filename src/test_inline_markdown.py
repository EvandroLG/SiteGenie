...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        ...
        self.assertListEqual(
            [("Link text", "https://www.example.com")], extract_markdown_links(text1)
        )
    ...
    def test_split_nodes_image(self):
        node1 = TextNode(
            "Hello is text with ![Alt text](https://www.example.com/image.png)",
            text_type_text,
        )
        self.assertListEqual(
            [
        ...
        node2 = TextNode(
            "Hello is text with ![Alt text 1](https://www.example.com/image1.png) ![Alt text 2](https://www.example.com/image2.png)",
            text_type_text,
        )
        self.assertListEqual(
            [
                TextNode("Hello is text with ", text_type_text),
                TextNode(
                    "Alt text 1", text_type_image, "https://www.example.com/image1.png"
                ),
                TextNode(" ", text_type_text),
                TextNode(
                    "Alt text 2", text_type_image, "https://www.example.com/image2.png"
                ),
            ],
        ...
        node3 = TextNode(
            "Hello is text with ![Alt text](https://www.example.com/image.png) and ![Alt text](https://www.example.com/image.png)",
            text_type_text,
        )
        self.assertListEqual(
            [
    ...
    def test_split_nodes_link(self):
        node1 = TextNode(
            "Hello is text with [Link text](https://www.example.com)", text_type_text
        )
        self.assertListEqual(
            [
                TextNode("Hello is text with ", text_type_text),
        ...
        node2 = TextNode(
            "Hello is text with [Link text 1](https://www.example.com) [Link text 2](https://www.example.com)",
            text_type_text,
        )
        self.assertListEqual(
            [
        ...
        node3 = TextNode(
            "Hello is text with [Link text](https://www.example.com) and [Link text](https://www.example.com)",
            text_type_text,
        )
        self.assertListEqual(
            [
